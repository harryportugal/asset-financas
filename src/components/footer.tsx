							...
							<motion.div variants={childParentVariants} className="flex flex-col gap-3">
								...
								<div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-3">
									<a 
										...
										target="_blank"
										rel="noopener noreferrer"
										className="w-fit flex items-center gap-3 bg-black/20 hover:bg-black/30 border border-white/10 active:scale-98 transition-all duration-200 rounded-xl px-3 py-2.5 text-white"
									>
