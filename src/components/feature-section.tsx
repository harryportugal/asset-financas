...
function FeatureTitle({ className, ...props }: React.ComponentProps<"h3">) {
	return (
		<h3
			className={cn("font-bold text-gray-900 text-[16.5px] tracking-tight", className)}
			{...props}
		/>
	);
}
...
function FeatureDescription({
	...
	return (
		<p className={cn("text-gray-800 text-[13px] leading-relaxed", className)} {...props} />
	);
}
	...
	return (
		<div className="flex flex-col items-center justify-center h-full min-h-[260px]">
			...
			<div className="relative mt-6 space-y-2 text-center">
				<FeatureTitle>APIs Robustas e Prontas</FeatureTitle>
				<FeatureDescription>
					Integre serviços bancários e de pagamento ao seu software de forma simples, com documentação rica, SDKs modernos e suporte técnico ativo.
				</FeatureDescription>
			</div>
		</div>
	);
...
function UserBasedSecurity() {
	return (
		<div className="flex flex-col items-center justify-center h-full min-h-[260px]">
			...
			<div className="relative mt-6 space-y-2 text-center">
				<FeatureTitle>Compliance e Regulação</FeatureTitle>
				<FeatureDescription>
					Opere sem dores de cabeça regulatórias. Cuidamos de todo o compliance junto ao Banco Central, segurança jurídica, KYC e prevenção de fraudes.
				</FeatureDescription>
			</div>
		</div>
	);
	...
	return (
		<div className="grid h-full sm:grid-cols-2 min-h-[260px]">
			<div className="relative z-10 flex flex-col justify-center space-y-5 py-8 ps-8 pe-4">
				...
				<div className="space-y-2">
					<FeatureTitle className="text-base">
						Pix e Liquidação em Milissegundos
					</FeatureTitle>
					<FeatureDescription>
						Infraestrutura de alta performance com redundância múltipla em nuvem, garantindo processamento instantâneo de Pix 24/7 com disponibilidade máxima.
					</FeatureDescription>
				</div>
			</div>
...
function CustomLockIcon(props: React.ComponentProps<"svg">) {
	return (
		...
		>
			<path
				className="fill-current opacity-30 stroke-current"
